...
export default function StopSection({ stop }) {
  return (
    <article id={stop.id} className="scroll-mt-16 mb-12 pb-12 border-b border-stone-800 last:border-b-0">
      ...
      <div className="prose prose-invert prose-amber prose-a:text-amber-400 prose-a:no-underline hover:prose-a:underline max-w-none mb-8 prose-p:leading-relaxed">
        {stop.text.map((paragraph, i) => (
